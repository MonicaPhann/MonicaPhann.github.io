document.addEventListener('DOMContentLoaded', function() {
        ...
        let html = `
            ...
            <div class="centered-box">
                <figure class="intro-image">
                    <img src="${imageUrl}" alt="User uploaded image: ${imageCaption}" id="me">
    ...
    function prefillForm() {
        document.getElementById('name').value = 'Monica Phann';
        document.getElementById('mascot').value = 'Marvelous Panda';
        document.getElementById('imageCaption').value = 'Headshot of me';
        document.getElementById('personalBackground').value = 'I was born in Charlotte, NC and have lived here all my life.';
        document.getElementById('professionalBackground').value = 'I Currently work as a Repair/Lab Technician for a non-profit called E2D';
        document.getElementById('academicBackground').value = 'Sophomore with Computer Science major at UNCC.';
        document.getElementById('webdevBackground').value = 'I have very little knowledge about HTML, CSS, and JS.';
        document.getElementById('platform').value = 'Windows 11';
        document.getElementById('funnyThing').value = 'I have a dog named Toktok, based off of TukTuk cars.';
        document.getElementById('anythingElse').value = 'I have a twin!';
    }
